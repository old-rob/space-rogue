...
class Player extends Actor {
  ...
  act() {
    return new Promise((resolve) => {
      ...
      function handleKeypress(event) {
        if (this.warpSelect) {
          view.displayWarpMap(this.warpDisplay, 35, 45, this.selection);
  ...
  initWarp() {
    ...
    let warpMap = generator.createWarpMapFromString(ROT.RNG.getItem(moonStrings), 35, 45);
    this.warpDisplay = warpMap;
    ...
    for (let i = 0; i < string.length; i++) {
      ...
      switch (string[i]) {
        case "_": //Black
          ...
          break;
        case "*": //Star
          pixel = {sprite:"stars", fgColor:"white", bgColor:"black"};
          break;
        case "#": //Light grey (don't ask me)
          pixel = {sprite:"stars", fgColor:"darkgrey", bgColor:"darkgrey"};
          break;
        case "%": //Grey (it's darker than the other...)
          pixel = {sprite:"stars", fgColor:"grey", bgColor:"grey"};
          break;
        case "0": case "1": case "2": case "3":
          pixel = {sprite:"stars", fgColor:"grey", bgColor:"grey", selection:string[i]};
          break;
        default:
          alert(string[i]);
      }
...
class View {
  ...
  //tileArray is an array of objects with instructions for each spot
  displayWarpMap(tileArray, h, w, selection) {
  ...
  updateDisplay() {
    if (model.player.warpSelect) {
      this.displayWarpMap(model.player.warpDisplay, 35, 45, model.player.selection);
    } else {
...
"________________#############________________" +
"__________________#########__________________" +
"_*______________________________________*____" +
"_____________________________________________" +
"_____________________________________________" +
...
let waxingGibbousMoonWarpString =
"_____________________________________________" +
"_____________________________________*_______" +
"_____________________________________________" +
"_______*___________________*_________________" +
...
let waxingCrescentMoonWarpString =
"_____________________________________________" +
"_____________________________________*_______" +
"_____________________________________________" +
"_______*___________________*_________________" +
...
let moonStrings = [fullMoonWarpString, gibbousMoonWarpString, waxingGibbousMoonWarpString, waxingCrescentMoonWarpString];
